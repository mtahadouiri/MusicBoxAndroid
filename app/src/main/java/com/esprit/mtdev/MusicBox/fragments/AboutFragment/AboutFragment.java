package com.esprit.mtdev.MusicBox.fragments.AboutFragment;
...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        if (SplashActivity.tf4 != null) {
            ...
            fragTitle.setTypeface(com.esprit.mtdev.MusicBox.activities.SplashActivity.tf4);
        }
        ...
        if (HomeActivity.isReloaded) {
            ...
            bottomMarginLayout.getLayoutParams().height = com.esprit.mtdev.MusicBox.utilities.CommonUtils.dpTopx(65, getContext());
        }
