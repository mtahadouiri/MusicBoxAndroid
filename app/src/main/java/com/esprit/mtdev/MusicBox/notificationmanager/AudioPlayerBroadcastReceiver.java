package com.esprit.mtdev.MusicBox.notificationmanager;
...
public class AudioPlayerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equalsIgnoreCase("com.esprit.mtdev.MusicBox.ACTION_PLAY_PAUSE")) {
            try {
        ...
        } else if (action.equalsIgnoreCase("com.esprit.mtdev.MusicBox.ACTION_NEXT")) {
        ...
        } else if (action.equalsIgnoreCase("com.esprit.mtdev.MusicBox.ACTION_PREV")) {
            try {
